...
//======================================================================================
// Function to move the mainWindow onto the main screen - called on startup and by timer
//======================================================================================
function mainScreen() {
...
function menuitem6OnClick() {
    ...
    if (answer === 1) {
        openURL("https://www.deviantart.com/yereverluvinuncleber/art/Steampunk-Colour-Picker-Widget-ver-1-0-1-362453937");
    }
}
//=====================
//End function
